...
import InternalDashboardLogin from "../pages/Authentication/InternalDashboardLogin";
import BasicDashboardLogin from "../pages/Authentication/BasicDashboardLogin";
import ProfessionalDashboardLogin from "../pages/Authentication/ProfessionalDashboardLogin";
...
const publicRoutes = [
  { path: "/internal-dashboard-login", component: <InternalDashboardLogin /> },
  { path: "/basic-dashboard-login", component: <BasicDashboardLogin /> },
  { path: "/professional-dashboard-login", component: <ProfessionalDashboardLogin /> },
